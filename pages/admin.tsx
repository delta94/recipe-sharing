                ...
                <tbody className='bg-white divide-y divide-gray-200'>
                  <tr>
                    ...
                    <td className='px-1 py-4 whitespace-nowrap'>
                      <button className='h-8 px-4 m-2 text-sm text-white transition-colors duration-150 bg-indigo-700 rounded-lg hover:bg-indigo-800'>
                        Confirm
                      </button>
                    </td>
                    <td className='px-1 py-4 whitespace-nowrap'>
                      <button className='h-8 px-4 m-2 text-sm text-white transition-colors duration-150 bg-red-700 rounded-lg '>
                        Delete
                      </button>
                    </td>
                  </tr>
